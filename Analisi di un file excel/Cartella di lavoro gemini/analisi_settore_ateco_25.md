...
```mermaid
mindmap
  root((Ateco 25: Prodotti in Metallo))
    25.1 Costruzioni Metalliche
      Elementi in acciaio
      Infissi e porte
    25.2 Cisterne e Radiatori
      Contenitori in metallo
    25.5 Fucinatura e Stampaggio
      Metallurgia delle polveri
    25.6 Trattamento Metalli
      Rivestimento
      Meccanica generale
    25.7 Coltelleria e Utensili
      Ferramenta
    25.9 Altri Prodotti
      Bulloneria
...
```mermaid
pie title Distribuzione Imprese per Sottocategoria (2023)
    "Elementi Costruzione" : 27773
    "Trattamento/Rivestimento" : 22232
    "Altri prodotti" : 13643
    "Coltelleria" : 3434
    "Altro (25.2, 25.3, 25.4, 25.5)" : 2182
```
